...
class RollupResult {
    constructor(duration, compiler, sourcemap) {
        ...
        this.errors = compiler.errors.map(munge_warning_or_error$1);
        this.warnings = compiler.warnings.map(munge_warning_or_error$1);
...
function munge_warning_or_error$1(warning_or_error) {
    return {
...
function munge_warning_or_error(message) {
